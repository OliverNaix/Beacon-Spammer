...
const uint8_t channels[] = {1, 2, 3}; // used Wi-Fi channels (available: 1-14)
...
const char ssids[] PROGMEM = {
  ...
  "Стоимость такой рекламы 50 рублей/день\n"
  "Тут может находиться любой текст\n"
  "Кстати, программирование, - это очень крутая вещь!\n"
  "Уважаемые Дедушки и Бабушки,\n"
  "вызывайте экзорциста\n"
  "В Вашу коробку с интернетом\n"
  "Вселился демон\n"
  "Get Off My LAN\n"
  "The Promised LAN\n"
  "The LAN Down Under\n"
